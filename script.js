...
const makeSound = key => {
    ...
    switch(key){
      ...
      case "be":
      let Be = new Audio('sounds/b-e.wav');
      Be.play();
      break;
      ...
      case "at":
        var At = new Audio('sounds/a-t.wav');
        At.play();
        break;
      ...
      case "an":
        var An = new Audio('sounds/a-n.wav');
        An.play();
        break;
  
        case "as":
        var As = new Audio('sounds/a-s.wav');
        As.play();
        break;
    
        case "it":
          var It = new Audio('sounds/a-s.wav');
          It.play();
          break;
